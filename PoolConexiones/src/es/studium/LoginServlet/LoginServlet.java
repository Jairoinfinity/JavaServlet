...
public class LoginServlet extends HttpServlet
{
	...
	ServletException, IOException
	{
		...
		try
		{
			...
			{
				//Verificar que existe el usuario y su correspondienteclave
				...
				if(!rset.next())
				{
					...
					out.println("<h3>Nombre de usuario ocontraseña incorrectos</h3>");
					out.println("<p><a href='index.html'>Volver a Login</a></p>");
				}
				else
				{
					//Si los datos introducidos son correctos
					//Crear una sesión nueva y guardar el usuariocomo variable de sesión
					...
					out.println("<p><a href='hazalgo'>Hazalgo</a></p>");
				}
			}
			out.println("</body>");
			out.println("</html>");
